document.addEventListener('DOMContentLoaded', () => {
    ...
    const caseType = 'bronze'; // Тип кейса для этого файла
    const caseCost = 100; // Вартість бронзового кейса
    ...
    function updateUI() {
        ...
        openCaseBtn.textContent = `Открыть ${amount} бронзовый кейс(-а) (${totalCost} очков)`;
